...
public class DBService {
   ...
   // UserProfile profile = AccountService.dbService.getUser(UserProfile);
    ...
    /*public UsersDataSet getUser(long id) throws DBException {
        try {
            return (new AccountService().get(id));
    ...
    public long addUser(String name) throws DBException {
        try {
            ...
            AccountService dao = new AccountService(DBService.getH2Connection());
            dao.createTable();
            //dao.insertUser(name);
            connection.commit();
